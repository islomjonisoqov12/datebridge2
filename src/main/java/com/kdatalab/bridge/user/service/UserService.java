...
public class UserService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        UserDtoProjection userInfo = userRepository.selectAllUserInfo(params.getLoginId());
        ...
        return new User(userInfo.getLoginId(), userInfo.getPassword(), true, true, true, !(userInfo.getStatus().equals('Y') || userInfo.getStatus().equals('N')), authorities );
    }
    ...
    public UserDto getUserInfo(String username) throws Exception{
        UserDto params = new UserDto();
        params.setLoginId(username);
        UserDto userInfo = (UserDto) userRepository.selectUserInfo(params.getLoginId());
     ...
     * @throws Exception
     */
    public UserDtoProjection getAllUserInfo(String username){
        UserDto params = new UserDto();
        params.setLoginId(username);
        return userRepository.selectAllUserInfo(params.getLoginId());
    }
    ...
    public HttpEntity<String> checkPassword(String inputPassword, String username) {
        ...
        UserDto params = new UserDto();
        params.setLoginId(username);
        UserDto userInfo = (UserDto) userRepository.selectAllUserInfo(params.getLoginId());
    ...
    public String editUserInfo(String newPassword, String newEmail, String name) {
    ...
    public List<UserDto> getUsersByQcChk(char n) {
        return userRepository.selectUserByQcChk(n);
    }
